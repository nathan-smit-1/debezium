...
public final class LogMinerEventFactory {
    ...
    public static LogMinerSchemaChangeRecord createSchemaChangeRecord(LogMinerEventRow event) {
    ...
    public static LogMinerSchemaChangeRecord createSchemaChangeRecord(Scn scn,
                                                                      ...
                                                                      Long objectId) {
        return new LogMinerSchemaChangeRecord(
                scn,
                tableId,
                redoSql,
                changeTime,
